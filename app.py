...
def main ():
    ...
    print("Hello Fiscalapi!")
    
    #vea como obtener sus credenciales https://docs.fiscalapi.com/credentials-info
    ...
    #### actualizar producto #### 
    # product: Product = Product(
    #     id="35ecf5b2-9a01-4bbd-a2aa-c4730869e829",
    #     description="Producto python con impuestos",
    #     unit_price=Decimal("100.00"),
    #     product_taxes=[
    #         ProductTax(
    ...
    ### Eliminar producto ###
    # api_response = client.products.delete("35ecf5b2-9a01-4bbd-a2aa-c4730869e829")
    # print(api_response)
    ...
    # api_response = client.people.get_by_id("5fd9f48c-a6a2-474f-944b-88a01751d432")
    # print(api_response)
    ...
    #     password="TestPassword1234!", # Contraseña para el dashboard
    # )
    ...
    ### Actualizar persona ###
    # person: Person = Person(
    #     id="2b5dadc5-7e55-41b2-888b-dd844ae5058e", # Id de la persona
    ...
    ### Eliminar persona ###
    # api_response = client.people.delete("2b5dadc5-7e55-41b2-888b-dd844ae5058e")
    # print(api_response)
    ...
    # api_response = client.tax_files.get_by_id("72dc9b5c-8055-4daa-a45b-51953b61b382")
    # print(api_response)
    
    
    ### Crear certificado (subir certificado a KARLA FUENTE NOLASCO) ###
    # tax_file: TaxFile = TaxFile(
    #     person_id="5fd9f48c-a6a2-474f-944b-88a01751d432",
    #     tin="FUNK671228PH6",
    ...
    # api_response_cer = client.tax_files.delete("154e0f80-ea8f-405a-b8a9-2801f914c687") #.cer
    # print(api_response_cer)
    
    # api_response_key = client.tax_files.delete("2ec15971-d252-4278-8fc0-09c9256271c3") #.key
    ...
    # api_response = client.tax_files.get_default_values("78d380fd-1b69-4e3c-8bc0-4f57737f7d5f")
    # print(api_response)
    
    
    ### Obtener certificados por defecto de una persona (ids) ###
    # api_response = client.tax_files.get_default_references("78d380fd-1b69-4e3c-8bc0-4f57737f7d5f")
    # print(api_response)
    ...
    ### obtener registro de un catalogo por nombre y id  (obtiene el uso de cfdi con cuyo id es igual a 'G03' (Gastos en general) del catalogo de usos de cfdi (SatCfdiUses) ) ###
    # api_response = client.catalogs.get_record_by_id("SatCfdiUses", "G03")
    # print(api_response)
    
    
    ### buscar en un catalogo por nombre y texto de busqueda (obtiene los registros del catalogo de formas de pago (SatPaymentForms) que contengan la palabra "tarjeta") ###
    ...
    # api_response = client.invoices.get_by_id("07abdeb5-7277-4bb8-a4b8-49e644b85291",True)
    # print(api_response)
   ...
   ### Crear factura de ingreso por valores (Sdk).  ###
    ...
    #     invoice_uuid="f428c3f6-bfd5-40f6-b91a-6fcf34376989",
    #     tin="FUNK671228PH6",
    ...
    # cancel_request = CancelInvoiceRequest(
    #     id="181d11b8-2638-4f8e-a622-075bdebffcf7",
    #     cancellation_reason_code="01",
    #     replacement_uuid="de841944-bd4f-4bb8-adfe-2a2282787c62"
    # )
    # api_response = client.invoices.cancel(cancel_request)   
    ...
    # create_pdf_request = CreatePdfRequest(invoice_id="181d11b8-2638-4f8e-a622-075bdebffcf7")
    # api_response = client.invoices.get_pdf(create_pdf_request)
    # print(api_response)
